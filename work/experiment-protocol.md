...
사용자가 초기 코드 위치로 지정한 legacy_r의 원주시 결측보정 코드를 기준으로 사용한다. 승인된 R/Python 컨테이너를 준비했으며 계산을 유지한 경로·Java 환경·대상 날짜 조정을 검증했다. 실행 결과는 ../assets/work-evidence/transit-comparison.json과 포트폴리오의 비교 표를 따른다.
